...
function! s:DefaultHighlightings()
	...
	elseif g:mwDefaultHighlightingPalette ==# 'extended'
		let l:palette = [
		\   { 'ctermbg':'DarkBlue',   'ctermfg':'Black', 'guibg':'#A1B7FF', 'guifg':'#001E80' },
		\   { 'ctermbg':'DarkMagenta','ctermfg':'Black', 'guibg':'#FFA1C6', 'guifg':'#80005D' },
		\   { 'ctermbg':'DarkGreen',  'ctermfg':'Black', 'guibg':'#ACFFA1', 'guifg':'#0F8000' },
		\   { 'ctermbg':'DarkYellow', 'ctermfg':'Black', 'guibg':'#FFE8A1', 'guifg':'#806000' },
		\   { 'ctermbg':'DarkCyan',   'ctermfg':'Black', 'guibg':'#D2A1FF', 'guifg':'#420080' },
		\   { 'ctermbg':'DarkRed',    'ctermfg':'Black', 'guibg':'#A1FEFF', 'guifg':'#007F80' },
		\   { 'ctermbg':'Brown',      'ctermfg':'Black', 'guibg':'#A1DBFF', 'guifg':'#004E80' },
...
if !hasmapto('<Plug>MarkAllClear', '-')
	nmap <unique> <silent> <Leader>- <Plug>MarkAllClear
endif
